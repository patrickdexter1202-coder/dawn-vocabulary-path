...
- [产品规格 v0.8](english-learning-system-spec-v0.8.md)：已上线能力、默认词库、本地数据、部署与剩余边界。
- [实施状态 v0.8](implementation-plan-v0.8.md)：v0.7 计划的交付结果、证据和剩余真机验收。
...
- [原生 iOS 开发评估（暂缓）](ios-development-assessment.md)：历史路线评估；v0.8 仅使用 iPhone Safari 访问网页。
- [本地开发与部署](local-deployment.md)：当前本机项目的运行、构建、数据和语音依赖。
- [设计与质量验收](../design-qa.md)：响应式、交互、自动化测试和待验项目。

## 历史文档

`english-learning-system-spec-v0.1.md` 至 `v0.7.md`、`implementation-plan-v0.1.md` 至 `v0.7.md` 是历史快照，只用于追溯需求和实施过程，不再代表当前完整行为。
